...
window.addEventListener("DOMContentLoaded", function() {
    ...
    if(tradBar) {
        ...
        linkedIn.setAttribute('href', 'https://www.linkedin.com/in/anais-keramphele-24b61693');

        flagVersion.style.background= "padding-box no-repeat center/ cover url('./images/fr-flag.png')";

    }
    else {
        flagLink.setAttribute('href', "https://translate.google.com/translate?sl=fr&tl=en&u=https://yann-dv.github.io/Ana_cv-app/");
